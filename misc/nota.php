...
$pdf->Cell(60,10,'Toko',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Alamat: Jl. Imam Bonjol ',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Menjual Aneka Sembako',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'No. Telp: 08xxxxx',0,1,'C');
